...
public class MatrizGUIForm extends javax.swing.JFrame {
    ...
    activarOrdenamiento(tblA);
    activarOrdenamiento(tblB);
    activarOrdenamiento(tblResultado);
